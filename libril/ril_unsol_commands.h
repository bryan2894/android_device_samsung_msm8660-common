...
*/
    ...
    {RIL_UNSOL_CELL_INFO_LIST, NULL, WAKE_PARTIAL}, // 1036
    {RIL_UNSOL_RESPONSE_IMS_NETWORK_STATE_CHANGED, NULL, WAKE_PARTIAL}, // 1037
    {RIL_UNSOL_UICC_SUBSCRIPTION_STATUS_CHANGED, NULL, WAKE_PARTIAL}, // 1038
    {RIL_UNSOL_SRVCC_STATE_NOTIFY, radio::onSupplementaryServiceIndicationInd, WAKE_PARTIAL}, // 1039
    {RIL_UNSOL_HARDWARE_CONFIG_CHANGED, radio::stkCallControlAlphaNotifyInd, WAKE_PARTIAL}, // 1040
    {RIL_UNSOL_DC_RT_INFO_CHANGED, radio::subscriptionStatusChangedInd, WAKE_PARTIAL}, // 1041
    {RIL_UNSOL_RADIO_CAPABILITY, NULL, WAKE_PARTIAL}, // 1042
